...
import apiit.nibras.studentms.controller.models.PanelEnlistViewModel;
...
public class PanelEnlist extends ExtendedPanel {
	...
	private PanelEnlistViewModel viewModel;
	private JLabel lblProgram;
	private JLabel lblClasses;

	public PanelEnlist(PanelEnlistViewModel viewModel) {
		...
		this.cmbProgram.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				PanelEnlist.this.handleProgramActionPerformed(arg0);
			}
		});
